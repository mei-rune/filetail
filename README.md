...
The archive comes with a [sample config](https://github.com/runner-mei/filetail/blob/master/example_config.yml). Optionally:
...
Here's an [advanced config](https://github.com/runner-mei/filetail/blob/master/examples/log_files.yml.example.advanced) which uses all options.
...
1. See whether the issue has already been reported: <https://github.com/runner-mei/filetail/issues/>
...
run:
    ...
    go get github.com/runner-mei/filetail
...
[releases]: https://github.com/runner-mei/filetail/releases
